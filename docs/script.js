...
function hideBanner()   { var b = document.getElementById('cookie-banner'); if (b) { b.classList.remove('visible'); b.style.display = 'none'; b.style.display = 'none'; } }

function acceptCookies() {
  localStorage.setItem('cookieConsent', 'all');
  hideBanner(); closeModal('cookie-settings');
  updateToggles({ analytics: true, affiliate: true }); document.body.style.overflow = '';
...
function declineCookies() {
  ...
  hideBanner(); closeModal('cookie-settings');
  updateToggles({ analytics: false, affiliate: false }); document.body.style.overflow = '';
  document.body.style.overflow = '';
}
